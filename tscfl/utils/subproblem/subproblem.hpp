...
public:
    ...
    // Dado (a_frac, b_frac) da solução atual do mestre, encontra a_int e b_int e resolve o subproblema.
    // Atualiza: theta, rhs, coef_a, coef_b
    // Retorna: valor da solução primal heurística encontrada
    IloNum solve_primal_heuristic(
        const IloNumArray &a_frac,
        const IloNumArray &b_frac,
        IloNumArray &a_int,
        IloNumArray &b_int)
    {
    ...
    // Dado (var_a, var_b) da solução atual do mestre, encontra a_int e b_int e resolve o subproblema.
    // Atualiza: theta, rhs, coef_a, coef_b
    // Retorna: valor da solução primal heurística encontrada
    IloNum solve_primal_heuristic(
        const IloCplex &cpx,
        ...
        IloNumArray &b_int)
    {
        IloNumArray a_frac(var_a.getEnv(), var_a.getSize()), b_frac(var_b.getEnv(), var_b.getSize());
